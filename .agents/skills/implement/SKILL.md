...
2. Resolve provisional metadata and acceptance before coding. Respect existing assignment/dependency failures; do not move another snapshot's task silently. Use Terra/high for normal coding and the [routing policy](../../../docs/ai/MODELS.md) when complexity warrants another model.
