...
extern double g_randomVectors[256 * 4];
...
// Noise module
constexpr int X_NOISE_GEN = 1619;
constexpr int Y_NOISE_GEN = 31337;
constexpr int Z_NOISE_GEN = 6971;
constexpr int SEED_NOISE_GEN = 1013;
constexpr int SHIFT_NOISE_GEN = 8;
