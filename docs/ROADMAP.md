...
Next version is EarlyDev 0.0.0 - Initiation.
...
Plans for EarlyDev 0.0.1 (not split into snapshots) - BasicBlocks:
...
Plans for EarlyDev 0.0.3 - BasicWorldGen:
...
Plans for EarlyDev 0.0.4 - Sky&Graphics:
...
Plans for EarlyDev 0.0.5 - Crafting:
...
Plans for EarlyDev 0.0.8 - Mobs:
1. Health bar.
2. Fighting system.
3. Peaceful mobs.

Plans for EarlyDev 0.0.9 - Enemies:
...
Plans for GeographyDev 0.1.3 - Caves:
...
Plans for GeographyDev 0.1.4 - Underwater:
1. Weeds of all kinds.
2. Complex ocean terrain, new blocks.
3. Currents.

Plans for GeographyDev 0.1.5 - Sky&Weather:
1. Sky islands.
2. Seasons.
