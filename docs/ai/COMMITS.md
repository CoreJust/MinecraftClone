...
5. For minor/major completion, also record a **Terra/high** report on all changes from the task's baseline to that candidate tree. Use `model: gpt-5.6-terra`; all candidate identity fields must match.
