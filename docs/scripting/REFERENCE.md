...
player_declaration = "player", identifier, "character", character,
                     "at", coordinate, coordinate ;
command       = input | wait | expect_position ;
input         = "input", identifier, direction, direction ;
wait          = "wait", positive_integer ;
expect_position = "expect", "player", identifier, "position",
...
`flat2d-v1` is the only supported profile in format version 1. It provides:
