...
namespace graphics::vulkan::internal {
    ...
    public:
        ...
        static void release(Vulkan& vulkan, core::ArrayView<T> items, void* allocator = nullptr);

        T get() const noexcept { return reinterpret_cast<T>(m_value); }
    };
    ...
    public:
        ...
        ~StandaloneResource() { Resource<T>::release(m_vulkan, { &this->m_value, 1 }, m_allocator); }
    };
