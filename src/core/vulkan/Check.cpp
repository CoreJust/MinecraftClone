...
bool tryHandleVkResult(VkResult const result) {
    switch (result) {
        ...
        case VK_ERROR_SURFACE_LOST_KHR:     return onSurfaceLost();
        case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT: return onFullscreenExclusiveModeLost();
        case VK_ERROR_OUT_OF_HOST_MEMORY:   return onOutOfHostMemory();
        case VK_ERROR_OUT_OF_DEVICE_MEMORY: return onOutOfDeviceMemory();
